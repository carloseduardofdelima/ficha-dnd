...
const SPELLS: Spell[] = [
  ...
  { id: 'booming-blade', name: 'Lâmina Estrondosa', level: 0, school: 'Evocação', castingTime: '1 ação', duration: '1 rodada', range: '1,5 m', components: 'S, M', description: 'Você brande uma arma e faz um ataque corpo-a-corpo. Se acertar, o alvo sofre efeitos normais do ataque e fica envolto em energia trovejante até o início do seu próximo turno. Se ele se mover voluntariamente antes disso, sofre 1d8 de dano de trovão.', damageEffect: '1d8 Trovão (mov)', classes: ['Feiticeiro', 'Bruxo', 'Mago', 'Artífice'], icon: 'electric-sword.png', sourceBook: 'Caldeirão de Tasha / Guia de Xanathar' },
  ...
  { id: 'green-flame-blade', name: 'Lâmina de Chama Esverdeada', level: 0, school: 'Evocação', castingTime: '1 ação', duration: 'Instantânea', range: '1,5 m', components: 'S, M', description: 'Você brande uma arma e faz um ataque corpo-a-corpo. Se acertar, chamas verdes saltam do alvo para outra criatura a 1,5m dele, causando dano de fogo igual ao seu modificador de conjuração.', damageEffect: 'Mod Fogo (sec)', classes: ['Feiticeiro', 'Bruxo', 'Mago', 'Artífice'], icon: 'flaming-sword.png', sourceBook: 'Caldeirão de Tasha / Guia de Xanathar' },
  ...
  { id: 'purify-food-drink', name: 'Purificar Alimentos', level: 1, school: 'Transmutação', castingTime: '1 ação (ritual)', duration: 'Instantânea', range: '3 m', components: 'V, S', description: 'Purifica comida e água.', damageEffect: 'Utilidade', ritual: true, classes: ['Clérigo', 'Druida', 'Paladino', 'Artífice'], icon: 'magic-potion.png' },
  ...
  { id: 'expeditious-retreat', name: 'Recuo Acelerado', level: 1, school: 'Transmutação', castingTime: '1 ação bônus', duration: '10 min', range: 'Pessoal', components: 'V, S', description: 'Pode usar Disparar como ação bônus.', damageEffect: 'Mobilidade', concentration: true, classes: ['Bruxo', 'Mago', 'Feiticeiro', 'Artífice'], icon: 'speed-step.png' },
...
export function getSpellsForClass(className: string, ruleset: '2014' | '2024' | '5e-custom' = '2024'): Spell[] {
  ...
  if (ruleset === '2014') {
    return SPELLS_2014.filter(s => s.classes.includes(className) && s.ruleset !== '5e-custom')
  }
  if (ruleset === '5e-custom') {
