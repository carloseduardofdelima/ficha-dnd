...
export const RACES_2014: Race[] = [
  ...
  },
  {
    ...
    subRaceMandatory: true,
    lineages: [
      { name: 'Negro (Ácido)', traits: [{ name: 'Resistência Dracônica', description: 'Você tem resistência a Ácido.' }] },
      ...
      { name: 'Vermelho (Fogo)', traits: [{ name: 'Resistência Dracônica', description: 'Você tem resistência a Fogo.' }] },
      { name: 'Prata (Frio)', traits: [{ name: 'Resistência Dracônica', description: 'Você tem resistência a Frio.' }] },
      { name: 'Branco (Frio)', traits: [{ name: 'Resistência Dracônica', description: 'Você tem resistência a Frio.' }] },
    ],
    traits: [
