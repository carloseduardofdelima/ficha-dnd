...
export const CLASS_PROGRESSION_2024: Record<string, ClassProgression> = {
  ...
  'Patrulheiro': {
    hitDie: 10,
    features: {
      1: ['Explorador Ágil (Especialização)', 'Inimigo Favorito (Marca do Caçador)', 'Spellcasting', 'Weapon Mastery (2 armas)'],
      2: ['Fighting Style'],
      3: ['Subclasse Patrulheiro [SC]', 'Explorador Ágil II'],
      4: ['Melhoria de Atributo ou Talento [ASI]'],
      5: ['Extra Attack'],
